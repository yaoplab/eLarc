...
class MainWindow(QWidget):
    ...
    def _build_event_types_btn(self):
        ...
        btn.setIcon(md3_icon("event", color=p.text_strong, size=theme_manager.image.icon_menu))
        btn.setIconSize(QSize(theme_manager.image.icon_menu, theme_manager.image.icon_menu))
